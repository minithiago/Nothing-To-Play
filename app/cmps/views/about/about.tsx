...
const items = [
    ...
    content: (
      <>
        ...
        <p>
          ...
          <Link href='https://www.igdb.com'>IGDB.com</Link>. This site is not
          endorsed by or affiliated with IGDB or Twitch.
        </p>
        <br />
        <p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Too many games, too little time. And yet, somehow, there's never
          anything to play.
        </p>
        <br />
        <p>
          This gallery features a collection of the most <i>reviewed*</i> games
          according to <Link href={config.tmdbUrl}>IGDB</Link>. The games are
          sorted by number of ratings in descending order, starting from the
          center of the grid and moving outward.
        </p>
        <br />
        <p>
          <small>
            <i>*Not to be confused with the highest rated games</i>
          </small>
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The game covers are packed into image montages, also known as texture
