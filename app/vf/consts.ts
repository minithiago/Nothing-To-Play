...
// Total games available in the generated dataset (set by the IGDB pipeline)
export const MAX_CELLS = Number(import.meta.env.VITE_GAME_COUNT ?? 10000)
...
export const CELL_LIMIT_ITEMS: Array<{
  value: CELL_LIMIT
  label: string
  recommendedDeviceClass?: DEVICE_CLASS
